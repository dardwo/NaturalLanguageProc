# kod z blogu z wykładu https://blog.polengmt.com/blog/jak-nauczyc-komputer-rozmawiania-z-czlowiekiem
...
def p_command(p):
    ...
    # Sell article
        ...
        tab[index] -= p[2]
        print(
            "OK. I am selling " + str(p[2]) + " articles indexed as " + str(index) + "."
        )
        print("No of articles in shop: " + str(tab[index]))
...
while True:
    ...
    if s == "Bye":
        ...
        print(f"Total number of products in shop: {sum(tab)}")
    else:
        parser.parse(s)
