...
_lr_productions = [
  ...
  ('command -> OPERATE NUMBER article','command',3,'p_command','D.py',78),
  ('attribute -> COLOR','attribute',1,'p_attribute_color','D.py',105),
  ('attribute -> MATERIAL','attribute',1,'p_attribute_material','D.py',111),
  ('attribute -> SIZE','attribute',1,'p_attribute_size','D.py',117),
  ('article -> KIND','article',1,'p_article_kind','D.py',123),
  ('article -> attribute article','article',2,'p_article_attribute','D.py',129),
]
