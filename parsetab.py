...
_lr_productions = [
  ...
  ('command -> OPERATE NUMBER article','command',3,'p_command','D.py',77),
  ('attribute -> COLOR','attribute',1,'p_attribute_color','D.py',95),
  ('attribute -> MATERIAL','attribute',1,'p_attribute_material','D.py',100),
  ('attribute -> SIZE','attribute',1,'p_attribute_size','D.py',105),
  ('article -> KIND','article',1,'p_article_kind','D.py',110),
  ('article -> attribute article','article',2,'p_article_attribute','D.py',115),
]
